...
SCHEMAS: dict[str, dict[str, Any]] = {
                ...
                **copy.deepcopy(_COMMON_DEFS),
                "caseSummary": {
                    ...
                    "properties": {
                        ...
                        "tls_callback_count": {"$ref": "#/$defs/count"},
                        "certificate_count": {"$ref": "#/$defs/count"},
                        "exception_count": {"$ref": "#/$defs/count"},
                        "delay_import_count": {"$ref": "#/$defs/count"},
                        "delay_import_symbol_count": {"$ref": "#/$defs/count"},
                        "guard_flag_count": {"$ref": "#/$defs/count"},
                        "clr_stream_count": {"$ref": "#/$defs/count"},
                        "fingerprint_count": {"$ref": "#/$defs/count"},
                        "rich_header_entry_count": {"$ref": "#/$defs/count"},
                        "version_info_count": {"$ref": "#/$defs/count"},
                        "import_count": {"$ref": "#/$defs/count"},
                        "export_count": {"$ref": "#/$defs/count"},
                        "symbol_count": {"$ref": "#/$defs/count"},
                        "relocation_count": {"$ref": "#/$defs/count"},
                        "code_range_count": {"$ref": "#/$defs/count"},
                        "function_count": {"$ref": "#/$defs/count"},
                        "basic_block_count": {"$ref": "#/$defs/count"},
                        "xref_count": {"$ref": "#/$defs/count"},
                        "callgraph_edge_count": {"$ref": "#/$defs/count"},
                        "import_call_count": {"$ref": "#/$defs/count"},
                        "code_edge_count": {"$ref": "#/$defs/count"},
                        "embedded_artifact_count": {"$ref": "#/$defs/count"},
                    },
                    "additionalProperties": True,
                },
            },
                ...
                **copy.deepcopy(_COMMON_DEFS),
                ...
                "extraction": {
                    ...
                    "properties": {
                        ...
                        "profile": {"$ref": "#/$defs/formatProfile"},
                        "apis": {"$ref": "#/$defs/apiProfile"},
                ...
                "formatProfile": {
                    ...
                    "properties": {
                        "engine": {"const": "traceforge-format-profile"},
                        "file_name": {"type": "string"},
                        "size": {"$ref": "#/$defs/count"},
                        "format": {"type": "string"},
                        "confidence": {"type": "string"},
                        ...
                        "observations": {
                            "type": "array",
                            "items": {"$ref": "#/$defs/profileObservation"},
                        },
                        "sections": {
                            "type": "array",
                            "items": {"type": "object", "additionalProperties": True},
                        ...
                        "entry_point": {"type": "object", "additionalProperties": True},
                    },
                    "additionalProperties": True,
                },
                "profileObservation": {
                    "type": "object",
                    "required": ["id", "level", "title", "detail", "evidence"],
                    "properties": {
                        "id": {"type": "string"},
                        "level": {"enum": ["info", "low", "medium", "high"]},
                        "title": {"type": "string"},
                        "detail": {"type": "string"},
                ...
                "apiProfile": {
                    ...
                    "properties": {
                        "engine": {"const": "traceforge-api-profile"},
                        "file_name": {"type": "string"},
                        "size": {"$ref": "#/$defs/count"},
                        "format": {"type": "string"},
                        "import_count": {"$ref": "#/$defs/count"},
                        "library_count": {"$ref": "#/$defs/count"},
                        "family_count": {"$ref": "#/$defs/count"},
                        "families": {
                            "type": "array",
                ...
                "callGraph": {
                    ...
                    "properties": {
                        "engine": {"const": "traceforge-callgraph"},
                        "file_name": {"type": "string"},
                        "format": {"type": "string"},
                        "architecture": {"type": "string"},
                        "node_count": {"$ref": "#/$defs/count"},
                        "edge_count": {"$ref": "#/$defs/count"},
                        "function_count": {"$ref": "#/$defs/count"},
                        "import_count": {"$ref": "#/$defs/count"},
                        "external_count": {"$ref": "#/$defs/count"},
                        "internal_call_count": {"$ref": "#/$defs/count"},
                        "import_call_count": {"$ref": "#/$defs/count"},
                        "branch_count": {"$ref": "#/$defs/count"},
                        "functions": {
                            "type": "array",
                            "items": {"type": "object", "additionalProperties": True},
                        },
    ...
    "api-profile": _document(
        "api-profile",
        "TraceForge API profile",
        "Import and API-family profile written by traceforge apis.",
        {
            "type": "object",
            "required": [
                "engine",
    ...
    "callgraph": _document(
        "callgraph",
        "TraceForge call graph",
        "Function, import, and external reference graph written by traceforge callgraph.",
        {
            "type": "object",
            "required": [
                "engine",
    ...
    "format-profile": _document(
        "format-profile",
        "TraceForge format profile",
        "Compact analyst profile written by traceforge profile.",
        {
            "type": "object",
            "required": [
                "engine",
            ...
            "properties": {
                ...
                "format": {"type": "string"},
                "confidence": {"type": "string"},
                "highest_level": {"enum": ["info", "low", "medium", "high"]},
                "summary": {"type": "object", "additionalProperties": True},
                "observations": {
                    "type": "array",
                    "items": {"$ref": "#/$defs/profileObservation"},
